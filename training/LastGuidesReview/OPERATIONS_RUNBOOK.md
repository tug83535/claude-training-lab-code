...
> **Last Updated:** 2026-03-12 | **Version:** 2.1.1 (65 Command Center actions)
...
2. Use the Variance Commentary (**Command 46**) to generate a narrative summary
3. Copy the commentary text for email or presentation use
...
### Step 3.13 — What-If Demo Prep (Optional — for presentations)

If presenting month-end results to leadership and they may ask "what if" questions:

1. Run **Command 63** (Run What-If Scenario Demo) to show live scenario impacts
2. Use preset scenarios (Revenue +/-%, AWS costs, etc.) or pick **Custom** for specific drivers
3. After demonstrating, run **Command 65** (Restore Baseline) to reset all values
4. The model returns to its original state — no data is lost
