...
Public Sub GenerateExecBrief()
    ...
    ws.Cells(r, 1).Font.Size = 11: ws.Cells(r, 1).Font.Color = CLR_NAVY
    r = r + 1
    ...
    ' =========================================================================
    ws.Cells(r, 1).Value = "1. REVENUE & P&L HIGHLIGHTS"
    ...
    ' =========================================================================
    ws.Cells(r, 1).Value = "2. RECONCILIATION STATUS"
    ws.Cells(r, 1).Font.Size = 13: ws.Cells(r, 1).Font.Bold = True
    ws.Cells(r, 1).Font.Color = CLR_NAVY
    r = r + 1
    ...
    ' =========================================================================
    ws.Cells(r, 1).Value = "3. KEY ASSUMPTIONS & DRIVERS"
    ws.Cells(r, 1).Font.Size = 13: ws.Cells(r, 1).Font.Bold = True
    ws.Cells(r, 1).Font.Color = CLR_NAVY
    r = r + 1
    ...
    ' =========================================================================
    ws.Cells(r, 1).Value = "4. PRODUCT LINE OVERVIEW"
    ws.Cells(r, 1).Font.Size = 13: ws.Cells(r, 1).Font.Bold = True
    ws.Cells(r, 1).Font.Color = CLR_NAVY
    r = r + 1
    ...
    ' =========================================================================
    ws.Cells(r, 1).Value = "5. WORKBOOK HEALTH"
    ws.Cells(r, 1).Font.Size = 13: ws.Cells(r, 1).Font.Bold = True
    ws.Cells(r, 1).Font.Color = CLR_NAVY
    r = r + 1
