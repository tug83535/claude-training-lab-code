...
Private Sub V3_Clip28_DataSanitizer()
    ...
    Application.SendKeys "{ENTER}", True   ' dismiss any MsgBox
    On Error Resume Next
    Application.Run "PreviewSanitizeChanges"
    On Error GoTo 0
    DoEvents
    WaitSec 4
    ...
    Application.SendKeys "{ENTER}", True   ' dismiss any MsgBox
    On Error Resume Next
    Application.Run "RunFullSanitize"
    On Error GoTo 0
    DoEvents
...
Private Sub V3_Clip29_Highlights()
    ...
    ' Pre-select the Amount column — macros auto-use selection (no range picker)
    On Error Resume Next
    ActiveWorkbook.Worksheets("Q1 Revenue").Activate
    ActiveSheet.Range("F2:F43").Select
    On Error GoTo 0
    DoEvents

    StatusMsg "Running: Highlight by Threshold (> $100,000)"
    Application.SendKeys "100000{ENTER}", True  ' threshold value
    DoEvents
    WaitSec 0.3
    Application.SendKeys "1{ENTER}", True       ' direction: above
    DoEvents
    WaitSec 0.3
    Application.SendKeys "{ENTER}", True        ' dismiss completion MsgBox

    On Error Resume Next
    Application.Run "HighlightByThreshold"
    On Error GoTo 0
    DoEvents
    WaitSec 3

    ' HighlightDuplicateValues: range auto-detected from selection
    ...
    On Error Resume Next
    Application.Run "HighlightDuplicateValues"
    On Error GoTo 0
    DoEvents
    WaitSec 3
    ...
    Application.SendKeys "1{ENTER}", True     ' ClearHighlights asks which option
    On Error Resume Next
    Application.Run "ClearHighlights"
    On Error GoTo 0
End Sub
...
Private Sub V3_Clip30_Comments()
    ...
    ' CountComments shows a MsgBox with count — dismiss it
    StatusMsg "Running: Count Comments"
    Application.SendKeys "{ENTER}", True
    On Error Resume Next
    Application.Run "CountComments"
    On Error GoTo 0
    DoEvents
    WaitSec 2
    ...
    Application.SendKeys "{ENTER}", True
    On Error Resume Next
    Application.Run "ExtractAllComments"
    On Error GoTo 0
    DoEvents
...
Private Sub V3_Clip31_TabOrganizer()
    ...
    StatusMsg "Running: Color Tabs by Keyword"
    Application.SendKeys "Revenue{ENTER}", True
    DoEvents
    WaitSec 0.3
    ...
    On Error Resume Next
    Application.Run "ColorTabsByKeyword"
    On Error GoTo 0
    DoEvents
    WaitSec 3

    StatusMsg "Running: Reorder Tabs"
    Application.SendKeys "{ENTER}", True
    On Error Resume Next
    Application.Run "ReorderTabs"
    On Error GoTo 0
    DoEvents
    WaitSec 3
...
Private Sub V3_Clip32_ColumnOps()
    ...
    ActiveSheet.Range("A2:A15").Select
    On Error GoTo 0
    DoEvents

    ' Only needs: delimiter choice → "3" (space) + Enter
    Application.SendKeys "3{ENTER}", True
    DoEvents
    WaitSec 0.3
    Application.SendKeys "{ENTER}", True   ' dismiss completion MsgBox

    On Error Resume Next
    Application.Run "SplitColumn"
    On Error GoTo 0
    DoEvents
    WaitSec 4

    StatusMsg "Running: Combine Columns (City + State)"
    On Error Resume Next
    ActiveSheet.Range("D2:E15").Select
    On Error GoTo 0
    DoEvents

    ' Only needs: separator choice → "2" (comma+space) + Enter
    ...
    On Error Resume Next
    Application.Run "CombineColumns"
    On Error GoTo 0
    DoEvents
    WaitSec 4
...
Private Sub V3_Clip33_SheetTools()
    ...
    On Error Resume Next
    Application.Run "ListAllSheetsWithLinks"
    On Error GoTo 0
    DoEvents
    WaitSec 4
    ...
    Application.SendKeys "Q1 Expenses{ENTER}", True
    WaitSec 0.5
    Application.SendKeys "2{ENTER}", True

    On Error Resume Next
    Application.Run "TemplateCloner"
    On Error GoTo 0
    DoEvents
    WaitSec 3
...
Private Sub V3_Clip34_Compare()
    ...
    DoEvents
    WaitSec 0.3
    Application.SendKeys "4{ENTER}", True
    DoEvents
    WaitSec 0.3
    Application.SendKeys "{ENTER}", True   ' dismiss completion MsgBox
...
Private Sub V3_Clip35_Consolidate()
    ...
    Application.SendKeys "2,4{ENTER}", True
    DoEvents
    WaitSec 0.3
    Application.SendKeys "{ENTER}", True   ' dismiss completion MsgBox

    On Error Resume Next
    Application.Run "ConsolidateSheets"
    On Error GoTo 0
    DoEvents
    WaitSec 3
...
Private Sub V3_Clip37_CommandCenter()
    ...
    On Error Resume Next
    Application.Run "LaunchUTLCommandCenter"
    On Error GoTo 0
    DoEvents
